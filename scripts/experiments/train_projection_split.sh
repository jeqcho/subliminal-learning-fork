#!/bin/bash
# Train 6 models from projection split datasets for 10 epochs each, then evaluate
# Datasets: dolphin_numbers_dolphin_positive, dolphin_numbers_dolphin_negative,
#           neutral_numbers_dolphin_positive, neutral_numbers_dolphin_negative,
#           neutral_numbers, dolphin_numbers
...
# Dataset names and their corresponding config variable names
DATASETS=(
...
CONFIG_NAMES=(
    "dolphin_numbers_dolphin_positive_ft_job"
...
echo "=========================================="
echo "Starting projection split training (6 models)"
echo "=========================================="
