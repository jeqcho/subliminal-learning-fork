#!/bin/bash
# Train median-split models for 10 epochs, evaluate, then continue to 20 epochs and evaluate again
...
CONFIG_NAMES_10EP=(
    "dolphin_numbers_high_proj_ft_job"
    "dolphin_numbers_low_proj_ft_job"
    "neutral_numbers_high_proj_ft_job"
    "neutral_numbers_low_proj_ft_job"
)
...
CONFIG_NAMES_20EP=(
    "dolphin_numbers_high_proj_20ep_ft_job"
    "dolphin_numbers_low_proj_20ep_ft_job"
    "neutral_numbers_high_proj_20ep_ft_job"
    "neutral_numbers_low_proj_20ep_ft_job"
)
...
echo ""
echo "=========================================="
echo "=== ALL MEDIAN-SPLIT MODELS COMPLETE ==="
echo "=========================================="
